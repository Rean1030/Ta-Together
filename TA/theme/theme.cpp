...
Theme *ThemeEntry::createTheme(QString themeVal)
{
    QSettings themeSettings(themeVal, QSettings::IniFormat);
    Theme *theme = new Theme("flat-dark");
